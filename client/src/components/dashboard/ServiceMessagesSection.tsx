...
export function ServiceMessagesSection({
  ...
  console.log("ServiceMessagesSection render:", {
    messageGroups,
  ...
  const renderMessagesList = () => {
    console.log("Rendering messages list. Groups:", messageGroups);
    return (
  ...
  const renderConversation = () => {
    const conversationMessages = messages.filter((msg) => msg.requestId === selectedMessageRequest?.id);
    console.log("Messages being displayed:", conversationMessages);
    console.log("Selected conversation:", selectedMessageRequest);
